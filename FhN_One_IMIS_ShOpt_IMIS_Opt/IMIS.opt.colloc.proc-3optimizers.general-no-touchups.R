...
#            data                   - data
#########################################################################################################
IMIS.opt.colloc.3optimizers.general.no.touch.ups <- function(B, B.re, number_k, D,parnames = c("c"),data=data, plots=3, ncoefs=0, optim.fun1, optim.fun2, optim.fun3,other=NULL){
	B0 = B*10
