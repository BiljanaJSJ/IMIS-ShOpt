...
#1. old optimizer
                    ...
                    if (1 %in% runIndex)  {optimizer  = res[[1]]}else{optimizer=NULL}
                    if (2 %in% runIndex)  {optimizer2 = res[[2]]}else{optimizer2=NULL}
                    if (3 %in% runIndex)  {optimizer3 = res[[3]]}else{optimizer3=NULL}
