...
t1=proc.time()[1]
##run the IMIS-ShOpt algorithm
output<- IMIS.opt.colloc.3optimizers.general.no.touch.ups(B, B.re, number_k,D, runIndex=c(1,3), parnames = c("c"),data=data, plots=0, ncoefs=ncoefs, optim.fun1, optim.fun2, optim.fun3,other)
